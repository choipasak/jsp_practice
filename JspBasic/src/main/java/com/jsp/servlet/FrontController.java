...
//앞에 무엇이든지 올 수 있어지면서 유연하게 처리할 수 있다.
@WebServlet("*.user")
public class FrontController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(uri){
		case "join":
			System.out.println("회원가입 요청이 들어왔다!");
			break;
			
		case "login":
			System.out.println("로그인 요청이 들어왔다!");
			break;
			
		case "update":
			System.out.println("회원 정보 수정 요청이 들어왔다!");
			break;
			
		case "delete":
			System.out.println("회원탈퇴 요청이 들어왔다!");
			break;
